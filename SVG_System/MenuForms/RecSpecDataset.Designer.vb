    ...
    Partial Public Class Sales_OrderTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Sales_Order] WHERE (([Sales_Order_ID] = @Original_Sales_Order_"& _ 
                "ID) AND ([Sale_Order_Date] = @Original_Sale_Order_Date) AND ([Sale_Total] = @Ori"& _ 
                "ginal_Sale_Total) AND ([Customer_ID] = @Original_Customer_ID) AND ([Employee_ID]"& _ 
            ...
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Sales_Order] ([Sales_Order_ID], [Sale_Order_Date], [Sale_Total"& _ 
                "], [Customer_ID], [Employee_ID]) VALUES (@Sales_Order_ID, @Sale_Order_Date, @Sal"& _ 
                "e_Total, @Customer_ID, @Employee_ID);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Sales_Order_ID, Sale_Order_Date, S"& _ 
                "ale_Total, Customer_ID, Employee_ID FROM Sales_Order WHERE (Sales_Order_ID = @Sa"& _ 
                "les_Order_ID)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Sales_Order] SET [Sales_Order_ID] = @Sales_Order_ID, [Sale_Order_Da"& _ 
                "te] = @Sale_Order_Date, [Sale_Total] = @Sale_Total, [Customer_ID] = @Customer_ID"& _ 
                ", [Employee_ID] = @Employee_ID WHERE (([Sales_Order_ID] = @Original_Sales_Order_"& _ 
                "ID) AND ([Sale_Order_Date] = @Original_Sale_Order_Date) AND ([Sale_Total] = @Ori"& _ 
                "ginal_Sale_Total) AND ([Customer_ID] = @Original_Customer_ID) AND ([Employee_ID]"& _ 
                " = @Original_Employee_ID));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Sales_Order_ID, Sale_Order_Date, Sale_Total,"& _ 
                " Customer_ID, Employee_ID FROM Sales_Order WHERE (Sales_Order_ID = @Sales_Order_"& _ 
                "ID)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
